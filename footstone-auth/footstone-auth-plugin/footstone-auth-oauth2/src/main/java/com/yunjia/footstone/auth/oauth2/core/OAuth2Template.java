 ...
 */
package com.yunjia.footstone.auth.oauth2.core;
...
import com.yunjia.footstone.auth.oauth2.core.OAuth2Constants.Param;
import com.yunjia.footstone.auth.oauth2.exception.OAuth2Exception;
import com.yunjia.footstone.auth.oauth2.model.AccessTokenModel;
import com.yunjia.footstone.auth.oauth2.model.ClientModel;
import com.yunjia.footstone.auth.oauth2.model.ClientTokenModel;
import com.yunjia.footstone.auth.oauth2.model.CodeModel;
import com.yunjia.footstone.auth.oauth2.model.RefreshTokenModel;
import com.yunjia.footstone.auth.oauth2.model.RequestAuthModel;
...
public class OAuth2Template {
    ...
    public void checkScope(String accessToken, String... scopes) {
        ...
        List<String> scopeList = StrUtil.splitTrim(at.scope, StrUtil.COMMA);
    ...
    public boolean isGrant(Object loginId, String clientId, String scope) {
        List<String> grantScopeList = StrUtil.splitTrim(getGrantScope(clientId, loginId), StrUtil.COMMA);
        List<String> scopeList = StrUtil.splitTrim(scope, StrUtil.COMMA);
    ...
    public void checkContract(String clientId, String scope) {
        List<String> clientScopeList = StrUtil.splitTrim(checkClientModel(clientId).contractScope, StrUtil.COMMA);
        List<String> scopeList = StrUtil.splitTrim(scope, StrUtil.COMMA);
    ...
    public void checkRightUrl(String clientId, String url) {
        ...
        // 3、是否在[允许地址列表]之中 
        List<String> allowList = StrUtil.splitTrim(checkClientModel(clientId).allowUrl, StrUtil.COMMA);
        if(AuthStrategy.INSTANCE.hasElement.apply(allowList, url) == false) {
    ...
    public ClientModel checkClientSecret(String clientId, String clientSecret) {
        ...
        OAuth2Exception.throwBy(cm.clientSecret == null || cm.clientSecret.equals(clientSecret) == false,
    ...
    public CodeModel checkGainTokenParam(String code, String clientId, String clientSecret, String redirectUri) {
        ...
        OAuth2Exception.throwBy(dbSecret == null || dbSecret.equals(clientSecret) == false,
                "无效client_secret: " + clientSecret);
    ...
    public AccessTokenModel converCodeToAccessToken(CodeModel cm) {
        ...
        at.expiresTime = System.currentTimeMillis() + (OAuth2Manager.getConfig().getAccessTokenTimeout() * 1000);
        // at.refreshExpiresTime = System.currentTimeMillis() + (OAuth2Manager.getConfig().getRefreshTokenTimeout() * 1000);
        return at;
    }
    ...
    public void saveCode(CodeModel c) {
        ...
        AuthManager.getAuthRepository()
                .setObject(splicingCodeSaveKey(c.code), c, OAuth2Manager.getConfig().getCodeTimeout());
    }
    ...
    public void saveCodeIndex(CodeModel c) {
        ...
        AuthManager.getAuthRepository()
                .set(splicingCodeIndexKey(c.clientId, c.loginId), c.code, OAuth2Manager.getConfig().getCodeTimeout());
    }
    ...
    public void saveAccessToken(AccessTokenModel at) {
        ...
        AuthManager.getAuthRepository().setObject(splicingAccessTokenSaveKey(at.accessToken), at, at.getExpiresIn());
    }
    ...
    public void saveAccessTokenIndex(AccessTokenModel at) {
        ...
        AuthManager.getAuthRepository()
                .set(splicingAccessTokenIndexKey(at.clientId, at.loginId), at.accessToken, at.getExpiresIn());
    }
    ...
    public void saveRefreshToken(RefreshTokenModel rt) {
        ...
        AuthManager.getAuthRepository().setObject(splicingRefreshTokenSaveKey(rt.refreshToken), rt, rt.getExpiresIn());
    }
    ...
    public void saveRefreshTokenIndex(RefreshTokenModel rt) {
        ...
        AuthManager.getAuthRepository()
                .set(splicingRefreshTokenIndexKey(rt.clientId, rt.loginId), rt.refreshToken, rt.getExpiresIn());
    }
    ...
    public void saveClientToken(ClientTokenModel ct) {
        ...
        AuthManager.getAuthRepository().setObject(splicingClientTokenSaveKey(ct.clientToken), ct, ct.getExpiresIn());
    }
    ...
    public void saveClientTokenIndex(ClientTokenModel ct) {
        ...
        AuthManager.getAuthRepository()
                .set(splicingClientTokenIndexKey(ct.clientId), ct.clientToken, ct.getExpiresIn());
    }
    ...
    public void savePastTokenIndex(ClientTokenModel ct) {
        ...
        AuthManager.getAuthRepository().set(splicingPastTokenIndexKey(ct.clientId), ct.clientToken, ct.getExpiresIn());
    }
    ...
    public void saveGrantScope(String clientId, Object loginId, String scope) {
        if(StrUtil.isNotBlank(scope)) {
            ...
            AuthManager.getAuthRepository().set(splicingGrantScopeKey(clientId, loginId), scope, ttl);
        }
    }
    ...
    public CodeModel getCode(String code) {
        ...
        return (CodeModel) AuthManager.getAuthRepository().getObject(splicingCodeSaveKey(code));
    }
    ...
    public String getCodeValue(String clientId, Object loginId) {
        return AuthManager.getAuthRepository().get(splicingCodeIndexKey(clientId, loginId));
    }
    ...
    public AccessTokenModel getAccessToken(String accessToken) {
        ...
        return (AccessTokenModel) AuthManager.getAuthRepository().getObject(splicingAccessTokenSaveKey(accessToken));
    }
    ...
    public String getAccessTokenValue(String clientId, Object loginId) {
        return AuthManager.getAuthRepository().get(splicingAccessTokenIndexKey(clientId, loginId));
    }
    ...
    public RefreshTokenModel getRefreshToken(String refreshToken) {
        ...
        return (RefreshTokenModel) AuthManager.getAuthRepository().getObject(splicingRefreshTokenSaveKey(refreshToken));
    }
    ...
    public String getRefreshTokenValue(String clientId, Object loginId) {
        return AuthManager.getAuthRepository().get(splicingRefreshTokenIndexKey(clientId, loginId));
    }
    ...
    public ClientTokenModel getClientToken(String clientToken) {
        ...
        return (ClientTokenModel) AuthManager.getAuthRepository().getObject(splicingClientTokenSaveKey(clientToken));
    }
    ...
    public String getClientTokenValue(String clientId) {
        return AuthManager.getAuthRepository().get(splicingClientTokenIndexKey(clientId));
    }
    ...
    public String getPastTokenValue(String clientId) {
        return AuthManager.getAuthRepository().get(splicingPastTokenIndexKey(clientId));
    }
    ...
    public String getGrantScope(String clientId, Object loginId) {
        return AuthManager.getAuthRepository().get(splicingGrantScopeKey(clientId, loginId));
    }
    ...
    public void deleteCode(String code) {
        if(code != null) {
            AuthManager.getAuthRepository().deleteObject(splicingCodeSaveKey(code));
        }
    }
    ...
    public void deleteCodeIndex(String clientId, Object loginId) {
        AuthManager.getAuthRepository().delete(splicingCodeIndexKey(clientId, loginId));
    }
    ...
    public void deleteAccessToken(String accessToken) {
        if(accessToken != null) {
            AuthManager.getAuthRepository().deleteObject(splicingAccessTokenSaveKey(accessToken));
        }
    }
    ...
    public void deleteAccessTokenIndex(String clientId, Object loginId) {
        AuthManager.getAuthRepository().delete(splicingAccessTokenIndexKey(clientId, loginId));
    }
    ...
    public void deleteRefreshToken(String refreshToken) {
        if(refreshToken != null) {
            AuthManager.getAuthRepository().deleteObject(splicingRefreshTokenSaveKey(refreshToken));
        }
    }
    ...
    public void deleteRefreshTokenIndex(String clientId, Object loginId) {
        AuthManager.getAuthRepository().delete(splicingRefreshTokenIndexKey(clientId, loginId));
    }
    ...
    public void deleteClientToken(String clientToken) {
        if(clientToken != null) {
            AuthManager.getAuthRepository().deleteObject(splicingClientTokenSaveKey(clientToken));
        }
    }
    ...
    public void deleteClientTokenIndex(String clientId) {
        AuthManager.getAuthRepository().delete(splicingClientTokenIndexKey(clientId));
    }
    ...
    public void deletePastTokenIndex(String clientId) {
        AuthManager.getAuthRepository().delete(splicingPastTokenIndexKey(clientId));
    }
    ...
    public void deleteGrantScope(String clientId, Object loginId) {
        AuthManager.getAuthRepository().delete(splicingGrantScopeKey(clientId, loginId));
    }
    ...
    public String randomCode(String clientId, Object loginId, String scope) {
        return RandomUtil.randomString(AuthConstant.BASE_CHAR_NUMBER, 60);
    }
