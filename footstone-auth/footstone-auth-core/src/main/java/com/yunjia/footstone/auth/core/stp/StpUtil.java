...
public class StpUtil {
    ...
    public static void setStpLogic(StpLogic stpLogic) {
        ...
        // 防止自定义 stpLogic 被覆盖
        AuthManager.putStpLogic(stpLogic);
    }
     ...
     */
    public static void login(Object id, LoginModel loginModel) {
     ...
     */
    public static void switchTo(Object loginId, VoidFunction function) {
