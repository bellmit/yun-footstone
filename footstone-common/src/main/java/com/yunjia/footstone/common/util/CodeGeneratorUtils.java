...
import com.yunjia.footstone.common.algorithms.SnowFlakeIDGenerator;
import com.yunjia.footstone.common.constants.CommonConstants;
import com.yunjia.footstone.common.date.DateFormatter;
...
public class CodeGeneratorUtils {
    ...
    static {
        // workerId 取值范围为 0至15
        int workerId = Math.abs(NetUtil.getLocalAddress().hashCode()) % (MAX_WORKER_ID + 1);
    ...
    public static String nextId(String prefix) {
        ...
        return Joiner.on(StrUtil.EMPTY).join(prefix, snowFlakeIDGenerator.nextId());
    }
