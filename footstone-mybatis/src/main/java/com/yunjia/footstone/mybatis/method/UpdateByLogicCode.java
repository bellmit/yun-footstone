 ...
 * @author sunkaiyun
 */
public class UpdateByLogicCode extends AbstractMethod {

    @Override
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        CommonSqlMethod sqlMethod = CommonSqlMethod.UPDATE_BY_LOGIC_CODE;
        ...
        String sql = String.format(sqlMethod.getSql(), tableInfo.getTableName(),
                ...
                CommonDbColumn.LOGIC_CODE.getDbFieldName(), "et." + CommonDbColumn.LOGIC_CODE.getEntityFieldName(),
                additional);
